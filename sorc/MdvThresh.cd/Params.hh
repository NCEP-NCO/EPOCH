...
public:
  ...
  char* ThreshFieldName;

  long ThreshValidSecs;

  tdrp_bool_t OneValueMin;

  double MinThresh;

  char* MinThreshUrl;

  char* MinThreshFieldName;

  tdrp_bool_t OneValueMax;

  double MaxThresh;

  char* MaxThreshUrl;

  char* MaxThreshFieldName;

  tdrp_bool_t ThreshMissing;

  tdrp_bool_t ReplacePassValues;
