...
#include <cstring>
...

  {
    ...
    tt->comment_hdr = tdrpStrDup("EnsFcstComb");
    ...
    tt->descr = tdrpStrDup("Input/output field names, any number one or more");
    tt->help = tdrpStrDup("");
    ...
    tt->param_name = tdrpStrDup("modelWeights");
    tt->descr = tdrpStrDup("Weights of models, same order ");
    tt->help = tdrpStrDup("");
    tt->array_offset = (char *) &_modelWeights - &_start_;
    tt->array_n_offset = (char *) &modelWeights_n - &_start_;
    tt->is_array = TRUE;
    tt->array_len_fixed = FALSE;
    ...
    // Parameter 'genTimeProcessHours'
    // ctype is 'int'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = INT_TYPE;
    tt->param_name = tdrpStrDup("genTimeProcessHours");
    tt->descr = tdrpStrDup("");
    tt->help = tdrpStrDup("Algorithm will run only on data at these generation time hours.");
    tt->array_offset = (char *) &_genTimeProcessHours - &_start_;
    tt->array_n_offset = (char *) &genTimeProcessHours_n - &_start_;
    tt->is_array = TRUE;
    tt->array_len_fixed = FALSE;
