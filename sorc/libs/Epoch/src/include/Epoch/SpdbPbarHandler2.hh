...
# ifndef    SpdbPbarHandler2_hh
# define    SpdbPbarHandler2_hh
...
//----------------------------------------------------------------
class SpdbPbarHandler2 : public SpdbPbarMetadata2
{
public:
  /**
