...
// ParamsObsInOut.cc
//
// TDRP C++ code file for class 'ParamsObsInOut'.
//
...
#include <cstring>
  ...
  ParamsObsInOut::ParamsObsInOut(const ParamsObsInOut& source)
  ...
  void ParamsObsInOut::operator=(const ParamsObsInOut& other)
  ...
  int ParamsObsInOut::loadFromArgs(int argc, char **argv,
                           char **override_list,
                           char **params_path_p,
                           bool defer_exit)
  {
  ...
  int ParamsObsInOut::loadApplyArgs(const char *params_path,
                            int argc, char **argv,
                            char **override_list,
                            bool defer_exit)
  {
  ...
  bool ParamsObsInOut::isArgValid(const char *arg)
  {
  ...
  int ParamsObsInOut::load(const char *param_file_path,
                   char **override_list,
  ...
  int ParamsObsInOut::loadFromBuf(const char *param_source_str,
                          char **override_list,
  ...
  int ParamsObsInOut::loadDefaults(int expand_env)
  {
    if (tdrpLoad(NULL,
                 _table, &_start_,
  ...
  void ParamsObsInOut::sync(void) const
  {
  ...
  void ParamsObsInOut::print(FILE *out, tdrp_print_mode_t mode)
  {
  ...
  int ParamsObsInOut::checkAllSet(FILE *out)
  {
  ...
  int ParamsObsInOut::checkIsSet(const char *paramName)
  {
  ...
  void ParamsObsInOut::freeAll(void)
  {
  ...
  void ParamsObsInOut::usage(ostream &out)
  {
  ...
  int ParamsObsInOut::arrayRealloc(const char *param_name, int new_array_n)
  {
  ...
  int ParamsObsInOut::array2DRealloc(const char *param_name,
                             int new_array_n1,
                             int new_array_n2)
  {
